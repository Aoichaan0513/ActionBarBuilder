...
dependencies {
    // implementation group: 'jp.aoichaan0513:ActionBarBuilder:1.1.6'
    implementation group: 'jp.aoichaan0513', name: 'ActionBarBuilder', version: '1.1.6'
}
```
...
dependencies {
    // implementation("jp.aoichaan0513:ActionBarBuilder:1.1.6")
    implementation("jp.aoichaan0513", "ActionBarBuilder", "1.1.6")
}
```
